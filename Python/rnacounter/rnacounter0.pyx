...
cpdef count_reads(object exons,object ckreads,bint multiple,bint stranded):
...
#def process_chunk(object ckexons,object sam,str chrom, options):
...
#def rnacounter_main(str bamname,str annotname, options):
...
#        options['normalize'] = float(Ncounter.n) / 1.0e6
#    else:
